...
class RateLimiter:
    ...
    def is_allowed(self, key: str) -> tuple[bool, int, int]:
        ...
        try:
            ...
            # Fail open: a Redis outage or quota error must not take down the
            # endpoints that depend on rate limiting (auth, queries).
            logger.exception("Rate limiter Redis call failed; allowing request")
